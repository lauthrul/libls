...
void test_md5()
{
    ...
    for (size_t i = 0; i < sizeof(files) / sizeof(string); i++)
    {
        ...
        cout << "crypto::file_md5(\"" << str << "\") = " << crypto::file_md5(str.c_str()) << endl;
    }
}
...
void test_sha1()
{
    ...
    {
        const string& str = files[i];
        cout << "crypto::file_sha1(\"" << str << "\") = " << crypto::file_sha1(str.c_str()) << endl;
    }
}
...
void test_sha256()
{
    ...
    {
        const string& str = files[i];
        cout << "crypto::file_sha256(\"" << str << "\") = " << crypto::file_sha256(str.c_str()) << endl;
    }
}
...
void test_des()
{
    ...
    for (size_t i = 0; i < sizeof(texts) / sizeof(string); i++)
    {
        ...
        str_en = crypto::des_encrypt(str.c_str(), str.length(), key.c_str(), crypto::crypto_pkcs7padding, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::des_decrypt(str_en.c_str(), len_en, key.c_str(), crypto::crypto_pkcs7padding, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        ...
        str_en = crypto::des_encrypt(str.c_str(), str.length(), key.c_str(), crypto::crypto_zeropadding, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::des_decrypt(str_en.c_str(), len_en, key.c_str(), crypto::crypto_zeropadding, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n");
        ...
        printf("     padding: crypto_pkcs7padding\n");
        str_en = crypto::des_encrypt_cbc(str.c_str(), str.length(), key.c_str(), crypto::crypto_pkcs7padding, iv, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::des_decrypt_cbc(str_en.c_str(), len_en, key.c_str(), crypto::crypto_pkcs7padding, iv, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n");
        ...
        printf("     padding: crypto_zeropadding\n");
        str_en = crypto::des_encrypt_cbc(str.c_str(), str.length(), key.c_str(), crypto::crypto_zeropadding, iv, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::des_decrypt_cbc(str_en.c_str(), len_en, key.c_str(), crypto::crypto_zeropadding, iv, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n\n");
...
void test_3des()
{
    ...
    for (size_t i = 0; i < sizeof(texts) / sizeof(string); i++)
    {
        ...
        printf("     padding: crypto_pkcs7padding\n");
        str_en = crypto::three_des_encrypt(str.c_str(), str.length(), key.c_str(), crypto::crypto_pkcs7padding, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::three_des_decrypt(str_en.c_str(), len_en, key.c_str(), crypto::crypto_pkcs7padding, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n");
        ...
        printf("     padding: crypto_zeropadding\n");
        str_en = crypto::three_des_encrypt(str.c_str(), str.length(), key.c_str(), crypto::crypto_zeropadding, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::three_des_decrypt(str_en.c_str(), len_en, key.c_str(), crypto::crypto_zeropadding, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n");
        ...
        printf("     padding: crypto_pkcs7padding\n");
        str_en = crypto::three_des_encrypt_cbc(str.c_str(), str.length(), key.c_str(), crypto::crypto_pkcs7padding, iv, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::three_des_decrypt_cbc(str_en.c_str(), len_en, key.c_str(), crypto::crypto_pkcs7padding, iv, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n");
        ...
        printf("     padding: crypto_zeropadding\n");
        str_en = crypto::three_des_encrypt_cbc(str.c_str(), str.length(), key.c_str(), crypto::crypto_zeropadding, iv, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::three_des_decrypt_cbc(str_en.c_str(), len_en, key.c_str(), crypto::crypto_zeropadding, iv, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n\n");
...
void test_aes()
{
    ...
    for (size_t i = 0; i < sizeof(texts) / sizeof(string); i++)
    {
        ...
        printf("     padding: crypto_pkcs7padding\n");
        str_en = crypto::aes_encrypt(str.c_str(), str.length(), key.c_str(), crypto::crypto_bit128, crypto::crypto_pkcs7padding, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::aes_decrypt(str_en.c_str(), len_en, key.c_str(), crypto::crypto_bit128, crypto::crypto_pkcs7padding, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n");
        ...
        printf("     padding: crypto_zeropadding\n");
        str_en = crypto::aes_encrypt(str.c_str(), str.length(), key.c_str(), crypto::crypto_bit128, crypto::crypto_zeropadding, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::aes_decrypt(str_en.c_str(), len_en, key.c_str(), crypto::crypto_bit128, crypto::crypto_zeropadding, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n");
        ...
        printf("     padding: crypto_pkcs7padding\n");
        str_en = crypto::aes_encrypt_cbc(str.c_str(), str.length(), key.c_str(), crypto::crypto_bit128, crypto::crypto_pkcs7padding, iv, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::aes_decrypt_cbc(str_en.c_str(), len_en, key.c_str(), crypto::crypto_bit128, crypto::crypto_pkcs7padding, iv, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n");
        ...
        printf("     padding: crypto_zeropadding\n");
        str_en = crypto::aes_encrypt_cbc(str.c_str(), str.length(), key.c_str(), crypto::crypto_bit128, crypto::crypto_zeropadding, iv, &len_en);
        printf("     encrypt: (hex) ");
        print_hex(str_en.c_str(), len_en);
        printf("\n");

        str_de = crypto::aes_decrypt_cbc(str_en.c_str(), len_en, key.c_str(), crypto::crypto_bit128, crypto::crypto_zeropadding, iv, &len_de);
        printf("     decrypt: %s\n", str_de.c_str());
        printf("       (hex): ");
        print_hex(str_de.c_str(), len_de);
        printf("\n\n\n");
...
void test_url_encode()
{
    ...
    for (size_t i = 0; i < sizeof(texts) / sizeof(string); i++)
    {
        ...
        stren = crypto::url_encode(text.c_str(), text.length());
        cout << "crypto::url_encode(\"" << text << "\") : = " << stren << endl;

        strde = crypto::url_decode(stren.c_str(), stren.length());
