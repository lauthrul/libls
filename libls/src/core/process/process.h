...
namespace lslib
{
    namespace process
    {
        ...
        LSLIB_API bool get_process_info_by_name(__out__ PROCESSENTRY32_list& pe_lst, _lpcstr lpProcessName, bool bCaseSensitive);
        ...
        // get the first one if multi processes have the same name
        LSLIB_API string get_process_path_by_name(_lpcstr lpProcessName);
